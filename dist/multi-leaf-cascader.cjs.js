...
function (_super) {
  ...
  Menus.prototype.getActiveOptions = function (values) {
    ...
    return arrayTreeFilter__default['default'](options, function (o, level) {
...
function (_super) {
  ...
  function Cascader(props) {
    ...
    _this.handleMenuSelect = function (targetOption, menuIndex, e) {
      ...
      if ('value' in _this.props || e.type === 'keydown' && e.keyCode !== KeyCode__default['default'].ENTER) {
    ...
    _this.handleKeyDown = function (e) {
      ...
      if (!_this.state.popupVisible && e.keyCode !== KeyCode__default['default'].BACKSPACE && e.keyCode !== KeyCode__default['default'].LEFT && e.keyCode !== KeyCode__default['default'].RIGHT && e.keyCode !== KeyCode__default['default'].ESC && e.keyCode !== KeyCode__default['default'].TAB) {
  ...
  Cascader.prototype.getCurrentLevelOptions = function () {
    ...
    var result = arrayTreeFilter__default['default'](options, function (o, level) {
      return o[_this.getFieldName('value')] === activeValue[level];
    }, {
      childrenKeyName: this.getFieldName('children')
    });
  ...
  Cascader.prototype.getActiveOptions = function (activeValue) {
    ...
    return arrayTreeFilter__default['default'](this.props.options || [], function (o, level) {
      return o[_this.getFieldName('value')] === activeValue[level];
    }, {
      childrenKeyName: this.getFieldName('children')
    });
...
exports.MultiLeafCascader = MultiLeafCascader;
